...
def init(target):
    ...
    for sub in ("work", "systems", "people", ".cairn", ".hooks"): (d / sub).mkdir(exist_ok=True)
...
5. Context lines, optional       on a work or system node: one sentence → path to a file outside the bundle
